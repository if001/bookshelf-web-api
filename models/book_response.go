...
// Validate validates this book response
func (m *BookResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *BookResponse) validateContents(formats strfmt.Registry) error {
...
func (m *BookResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *BookResponse) UnmarshalBinary(b []byte) error {
